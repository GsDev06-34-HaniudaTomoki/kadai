...
//２．データ登録SQL作成
$stmt = $pdo->prepare("SELECT * FROM gs_cms_table ORDER BY indate DESC LIMIT 5");//先頭5件のみ取得
$status = $stmt->execute();
...
if($status==false){
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){
    $view .= '<dt class="news-list--date">'.h($result["indate"]).'</dt>';//h関数はインジェクション回避関数(functions参照)
        ...
        <div class="wrapper">
                ...
                <div class="inner">
                    <ul class="feature-list clearfix">
                        <li class="clearfix">
                            ...
                            <p class="white">
                                <span class="point-topics">一流職人によるチーズ作り指導</span> 基本習得後は2ヶ月間チーズ職人の指導で自家製チーズ完成を目指します。
                            </p>
                        </li>
                        <li class="clearfix">
                        ...
                        <li class="last clearfix">
                            ...
                            <p class="white">
                                <span class="point-topics">初心者歓迎授業料後払い</span> 丸暗記ではなく、創りながら。
                                <br /> 初心者のための授業料後払い制度です。
                            </p>
                        </li>
                    </ul>
                </div>
            ...
            <section id="concept" class="contents-box">
                ...
                <p class="contents-summary">
                    今、世界中の人たちが足りないと感じている、栄養素があります。<br /> その栄養は『カルシウム』と『マグネシウム』
                    <br /> 小さい子供の成長に欠かせないカルシウム
                    <br /> イライラをなくすには欠かせないカルシウム
                    <br /> 今まで食べたことのないチーズから取れるカルシウム
                    <br /> そんな悩みを抱えているあなたこそ、
                    <br /> プロレベルのチーズ作りスキルを持つべきだと思うのです。
                    <br />
                </p>
                <p class="contents-summary">
                    できるだけ多くの若い人に本格的なチーズ作りのスキルを学ぶ機会を創りたい。<br /> そして願わくば、この場所から世界中の多くの人がおいしいと言えるような新感覚のチーズが生まれてほしい。
                </p>
                <p class="contents-summary">
                    そんな思いでデジタルハリウッドが<br /> チーズづくりのためだけの場所「チーズアカデミーTOKYO」をつくりました。
                </p>
                <p class="contents-summary">
                    最初は全くの初心者でOK。<br /> まずは純粋にチーズ作りを楽しんでいただくことから始めて、
                    <br /> 最後には現役で活躍する一流農家のサポートを受けながら
                    <br /> オリジナルのチーズを開発〜完成させます。
                </p>
                <p class="contents-summary">
                    卒業後の「就職」はもちろん「独立」まで、さまざまなサポート企業や<br /> チーズアクセラレーターがバックアップ。
                </p>
                    ...
                    <ul class="cource-list">
                        <li class="clearfix">
                            ...
                            <div class="cource-summary">
                                <h4>LABコース</h4>
                                <p>
                                    週末集中型の初心者対象のチーズ職人養成講座です。 週末集中型の初心者対象のチーズ職人養成講座です。 週末集中型の初心者対象のチーズ職人養成講座です。 週末集中型の初心者対象のチーズ職人養成講座です。 週末集中型の初心者対象のチーズ職人養成講座です。
                                </p>
                            </div>
                        </li>
                        <li class="clearfix">
            ...
            <section id="gallery" class="contents-box">
                ...
                <div class="inner">
                    <ul class="gallery-list clearfix">
                        <li>
                            <a href=""><img src="image/gallery01.jpg" alt="" /></a>
                        </li>
                        <li>
                            <a href=""><img src="image/gallery01.jpg" alt="" /></a>
                        </li>
            ...
            <section id="entry" class="contents-box">
                ...
                <p class="entry-summary">入学をご希望の方に向けて、学校説明会を実施しております。<br /> フォームからお申し込みください。（無料・完全予約制）
                </p>
            ...
            <section id="information" class="contents-box">
                ...
                <div class="inner">
                    ...
                    <p class="footer-caution">※実際にはチーズアカデミーという学校は存在しません。<br /> くれぐれも間違ってデジタルハリウッドにお問い合わせすることのないようにご注意ください。
                    </p>
                </div>
            </section>
            <!--end #information-->
